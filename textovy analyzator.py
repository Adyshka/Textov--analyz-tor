...
def login_and_analyze():
    ...
    # Vytvoření sloupcového grafu podle délky slov
    length_counts = {}
    for word in words:
        length = len(word)
        length_counts[length] = length_counts.get(length, 0) + 1

    # Nejdelší slovo pro určení výšky grafu
